...
<html
	...
	<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<table style="display: none!important;">
			<tr>
				<td>
					<div style="overflow: hidden; display: none; font-size: 1px; color: #ffffff; line-height: 1px; font-family: Arial; maxheight: 0px; max-width: 0px; opacity: 0;"> Welcome to MDB! </div>
				</td>
			</tr>
		</table>
		<!-- pre-header end -->
									...
									<tr>
										<td align="center" height="70" style="height: 70px;">
											<a href="" style="display: block; border-style: none !important; border: 0 !important;">
												<img width="100" border="0" style="display: block; width: 100px;" src="http://funkyimg.com/i/2Nc5L.png" alt="" />
											</a>
										</td>
									</tr>
									<tr>
					...
					<table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
						<tr>
							<td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight: 700; letter-spacing: 3px; line-height: 35px;" class="main-header">
								<!-- section text ======-->
								<div style="line-height: 35px">Your Assessment
									<span style="color: #5caad2;">Result</span>
								</div>
							</td>
						</tr>
						<tr>
								...
								<table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
									<tr>
										<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
											<!-- section text ======-->
											<p style="line-height: 24px; margin-bottom: 15px;"> Hi, firstName </p>
											<p style="line-height: 24px; margin-bottom: 15px;"> You're receiving this e-mail because your lecturer has graded your Assessment result.</p>
											
                                            <!-- pass start section -->
                                            <p style="line-height: 24px; margin-bottom: 20px;"> Congrats you have pass your Assessment, Keep it up. </p>
												...
												<tr>
													<td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
														...
														<div style="line-height: 22px;">
															<a style="color: #ffffff; text-decoration: none;">Score1 : 100%</a>
														</div>
													</td>
												</tr>
												<tr>
                                            ...
                                            <!-- fail start section -->
                                            <p style="line-height: 24px; margin-bottom: 20px;">Oh my god, You have failed your Assessment, have fun repeat the course.</p>
											<table border="0" align="center" width="180" cellpadding="0" cellspacing="0" bgcolor="5caad2" style="margin-bottom: 20px;">
												<tr>
													<td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;</td>
												</tr>
												<tr>
													<td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
														<!-- main section button -->
														<div style="line-height: 22px;">
															<a style="color: #ffffff; text-decoration: none;">Score2 : 100%</a>
														</div>
													</td>
												</tr>
												<tr>
                                            ...
                                            <p style="line-height: 24px; margin-bottom: 20px;">Lecturer's comment</p>
                                            <p style="line-height: 24px;padding:5px; margin-bottom: 20px;border:5px dotted rgba(0,0,0,0.1)">Comment</p>

                                            <!-- comment end section -->

											<p style="line-height: 24px"> If you have any problem, please send an e-mail to let us know.
												<br/> The OAS Lecturer team 
											</p>
										</td>
									</tr>
								</table>
											...
											<table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" class="container590">
												...
												<tr>
													<td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
														<div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;"> Email us: 
															<br />
															<a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">OAS.edu.my@gmail.com</a>
														</div>
													</td>
												</tr>
											</table>
												...
												<tr>
													<td>
														<table border="0" align="right" cellpadding="0" cellspacing="0">
															<tr>
																<td>
																	<a href="https://www.facebook.com/liho.98" style="display: block; border-style: none !important; border: 0 !important;">
																		<img width="24" border="0" style="display: block;" src="http://i.imgur.com/Qc3zTxn.png" alt="">
																		</a>
																	</td>
																	<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
																	<td>
																		<a href="https://twitter.com/liho_98" style="display: block; border-style: none !important; border: 0 !important;">
																			<img width="24" border="0" style="display: block;" src="http://i.imgur.com/RBRORq1.png" alt="">
																			</a>
																		</td>
																		<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
																		<td>
																			<a href="https://plus.google.com/100956812200203645080" style="display: block; border-style: none !important; border: 0 !important;">
																				<img width="24" border="0" style="display: block;" src="http://i.imgur.com/Wji3af6.png" alt="">
																				</a>
																			</td>
																		</tr>
																	</table>
												...
												<tr>
													<td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
														<div style="line-height: 24px;">
															<span style="color: #333333;">OAS Online Assessment Site</span>
														</div>
													</td>
												</tr>
											</table>

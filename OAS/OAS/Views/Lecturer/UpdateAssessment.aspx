<%@ Page Title="OAS | Update Assessment" Language="C#" MasterPageFile="~/MasterPage/MainSite.Master" EnableViewState="true" ViewStateEncryptionMode="Always" AutoEventWireup="true" CodeBehind="UpdateAssessment.aspx.cs" Inherits="OAS.Views.Lecturer.UpdateAssessment" %>
    ...
    <div style="position: fixed; top: 14%; width: 100%; color: #fff">
        <div id="sloganDiv" style="text-align: center;">
            <div style="margin: 20px;">
                <span id="slogan">Update Assessment</span>
            </div>
        </div>
    </div>
</asp:Content>

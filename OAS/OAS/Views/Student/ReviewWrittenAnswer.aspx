<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainSite.Master" AutoEventWireup="true" CodeBehind="ReviewWrittenAnswer.aspx.cs" Inherits="OAS.Views.Student.ReviewWrittenAnswer" %>
    ...
    <div style="position: fixed; top: 14%; width: 100%; color: #fff">
        <div id="sloganDiv" style="text-align: center;">
            <div style="margin: 20px;">
                <span id="slogan">Review Written Question & Answer</span>
            </div>
        </div>
    </div>
</asp:Content>

<%@ Page Title="OAS | Answer Written Question" Language="C#" MasterPageFile="~/MasterPage/MainSite.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="AnswerWritten.aspx.cs" Inherits="OAS.Views.Student.AnswerWritten" %>
    ...
    <div style="position: fixed; top: 14%; width: 100%; color: #fff">
        <div id="sloganDiv" style="text-align: center;">
            <div style="margin: 20px;">
                <span id="slogan">Answer Written Question</span>
            </div>
        </div>
    </div>
</asp:Content>
        ...
        <div class="content">
            ...
            <div class="box-wrapper">
                <div class="box" style="width: 100%; top: 50%; height: 80%; background-color: ;">
                    ...
                    <asp:Button ID="SubmitButton" runat="server" Text="Submit" OnClick="SubmitButton_OnClick" OnClientClick="return confirm('Are you sure submit your answer?');" />
                </div>
            </div>
        </div>
    </div>

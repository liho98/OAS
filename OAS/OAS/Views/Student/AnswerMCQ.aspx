<%@ Page Title="OAS | Answer MCQ" Language="C#" MasterPageFile="~/MasterPage/MainSite.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="AnswerMCQ.aspx.cs" Inherits="OAS.Views.Student.AnswerMCQ" %>
    ...
    <div style="position: fixed; top: 14%; width: 100%; color: #fff">
        <div id="sloganDiv" style="text-align: center;">
            <div style="margin: 20px;">
                <span id="slogan">Answer MCQ</span>
            </div>
        </div>
    </div>
</asp:Content>
